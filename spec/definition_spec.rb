...
describe('#Definition') do
  ...
  describe('#update') do
    it("updates a definition by its id") do
      definition1 = Definition.new("peach without fuzz", @word_id, nil)
      definition1.save()
      definition1.update("nectarine with fuzz", @word_id)
      expect(definition1.definition).to(eq("nectarine with fuzz"))
    end
  end
  ...
  describe('.find_by_word') do
    it("finds definitions for the word") do
      ...
      definition1 = Definition.new("peach without fuzz", @word_id, nil)
      definition1.save()
      definition2 = Definition.new("nectarine with fuzz", word2.id, nil)
      definition2.save()
